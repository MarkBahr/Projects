...
// Message that the match is correct!
...
// Message that the match is not correct.
...
const findMatch = function () {
  if (
    ...
    !image_6.classList.contains("found") &&
...
const showMatch = function () {
  ...
  if (
    image_8.classList.contains("found") &&
    !button8.classList.contains("found")
  ) {
  ...
  if (
    image_6.classList.contains("found") &&
    !button6.classList.contains("found")
  ) {
  ...
  if (
    image_4.classList.contains("found") &&
    !button4.classList.contains("found")
  ) {
